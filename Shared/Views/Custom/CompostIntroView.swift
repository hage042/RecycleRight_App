//
//  CompostIntroView.swift
//  RecycleRight
//
//  Created by Danny Hagenlocker on 4/5/22.
//

import SwiftUI

struct CompostIntroView: View {
        ...
        GeometryReader { proxy in
            ...
            .overlay(
                Image(horizontalSizeClass == .compact ? "Waves 1" : "Waves 2")
                    ...
                    .opacity(1)
                    .matchedGeometryEffect(id: "waves 1", in: namespace)
                    .accessibility(hidden: true)
            )
            .overlay(
                VStack(alignment: .leading, spacing: 16) {
                    Text("Learn to Compost")
                        .font(.title).bold()
                        .frame(maxWidth: .infinity, alignment: .leading)
                        .foregroundColor(.primary)
                        .matchedGeometryEffect(id: "title 1", in: namespace)
                    
                    Text("8 videos - 12 hours".uppercased())
                        .font(.footnote).bold()
                        .frame(maxWidth: .infinity, alignment: .leading)
                        .foregroundColor(.primary.opacity(0.7))
                        .matchedGeometryEffect(id: "subtitle 1", in: namespace)
                    
                    Text("A complete guide to composting at home...")
                        .font(.footnote)
                        .frame(maxWidth: .infinity, alignment: .leading)
                        .foregroundColor(.primary.opacity(0.7))
                    ...
                    HStack {
                        ...
                        Text("Taught by Danny and Tori Hagenlocker")
                ...
                .background(
                    Rectangle()
                        ...
                        .cornerRadius(30)
                        .blur(radius: 30)
                        .matchedGeometryEffect(id: "blur 1", in: namespace)
...
struct CompostIntroView_Previews: PreviewProvider {
    @Namespace static var namespace
    static var previews: some View {
        CompostIntroView(namespace: namespace, course: .constant(courses[0]))
