...
var mainfeature = [
    FeatureComp(index: 1, title: "Scan-A-Bin", subtitle: "Augmented Reality", text: "Scan your recycling bin's Recycle Right code and get localized data regarding...", image: "ARCamera", background: "Wavy 1", logo: "Badge-ARkit"),
    FeatureComp(index: 2, title: "Learn to Compost", subtitle: "20 sections - 3 hours", text: "Step-by-step guide to composting using RecycleRight's custom biogas digester called HomeGrown", image: "compostbin", background: "Wavy 2", logo: "Logo 4"),
    FeatureComp(index: 3, title: "E-Waste Disposal Map", subtitle: "20 sections - 3 hours", text: "Find the nearest trash and recycling centers with ease!", image: "MapIcon", background: "Wavy 3", logo: "Logo 1"),
